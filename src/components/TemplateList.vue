...
.poster-item :deep .ant-card {
  border-radius: 12px;
}
.poster-item :deep .ant-card-cover {
  height: 390px;
}
.poster-item :deep .ant-card-cover > img {
  width: 100%;
}
.poster-item :deep .ant-card-hoverable {
  box-shadow: 0px 5px 10px 0px rgba(0, 0, 0, 0.1);
}
.poster-item :deep .ant-card-body {
  padding: 0
}
.poster-item :deep .ant-card-meta {
  margin: 0;
}
.poster-item :deep .ant-card-meta-title {
  color: #333;
  padding: 10px 12px;
